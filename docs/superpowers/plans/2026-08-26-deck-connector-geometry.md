...
- [ ] **Step 3: Implement node and edge rendering**
...
- [ ] **Step 4: Run primitive and geometry tests**
...
- [ ] **Step 5: Commit the primitive unit**
...
- [ ] **Step 5: Run builder tests and generate the corrected deck**
...
- [ ] **Step 1: Add a failing broken-HTML regression test**
...
- [ ] **Step 3: Implement independent HTML parsing and validation**
...
- [ ] **Step 4: Run the complete deck gate**
...
- [ ] **Step 1: Implement Chrome discovery and deterministic capture**
...
- [ ] **Step 2: Run the CourseSmith numeric deck audit**
...
- [ ] **Step 3: Review every rendered slide**
...
- [ ] **Step 4: Update design and plan status**
